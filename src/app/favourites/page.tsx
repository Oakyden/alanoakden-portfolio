    ...
    >
      <div className="space-y-20">
        ...
        <ToolsSection title="Design">
          <Tool title="Figma">
            Always the go-to now. I actually used Adobe XD for quite a while as it was part of creative suite, but working with a team of designers often leads to figma being the go-to.
          </Tool>
